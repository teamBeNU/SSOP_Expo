...
export default function TemplateStudentTeenager ({navigation, card_template}) {
    ...
    const [card_student_school, setCardStudentSchool] = useState(null)
    const [card_student_grade, setCardStudentGrade] = useState(null)
    const [card_student_major, setCardStudentMajor] = useState(null)
    const [card_student_id, setCardStudentId] = useState(null)
    const [card_student_club, setCardStudentClub] = useState(null)
    const [card_student_role, setCardStudentRole] = useState(null)
