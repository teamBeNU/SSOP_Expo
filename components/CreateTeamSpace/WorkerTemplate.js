...
export default function WorkerTemplate({ navigation, goToOriginal, teamName, teamComment, istemplate, template }) {
  ...
  const handleSelect = (id) => {
    switch (id) {
      ...
      case 'showEmail':
        ...
        break;
      case 'showInsta':
        setShowImsta((prevState) => !prevState);
        break;
      case 'showX':
          ...
          {step === 1 && (
            <View style={{ height: '100%' }}>
              <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <Text style={styles.font16}>직장인정보</Text>
                <View style={styles.elementContainer}>
                  {/* 회사 */}
