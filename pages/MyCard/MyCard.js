...
function MyCard() {
    ...
    const handleDelete = () => {
        setMoreMenu(false);
        navigation.navigate('내 카드 삭제', {cardData, setCardData, viewOption });
    };
    ...
    return (
        ...
        <View style={{flex: 1}}> 
            {hasCard ? (
            <View style={{flex: 1}} >
                <CardsView cardData={cardData} setCardData= {setCardData} refreshData={fetchData} viewOption={viewOption} setViewOption={setViewOption}/>
